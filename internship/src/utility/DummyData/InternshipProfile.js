import Airbnb from '../../images/InternFrame3/Airbnb.png';
...
export const dataCmp2 ={
      ...
      ppo:'No',
       ...
       text: (
           <>
              <p className="para_gap">Gubagoo is a fast growing provider of messaging and commerce solutions for automotive dealers changing the future of how people find, buy and service their vehicles.</p><br></br>
              <h3>Your Role:</h3>
              ...
              <ul className="para_gap list_of_ss">
               <li className="list_gap">Contribute new controls or design improvements to our</li>
               <li className="list_gap">Take ownership of the successful delivery of features</li>
               <li className="list_gap">Help set and achieve quarterly goals</li>
               <li className="list_gap">Ship a TON of product improvements and features</li>
              </ul>
            </>
       ),
